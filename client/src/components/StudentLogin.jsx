...
import { signInWithGoogle, signInWithEmail, getGoogleRedirectResult } from '../services/authService'
...
export default function StudentLogin({ onNavigate }) {
  ...
  // Handle Google redirect result (fallback when popups are blocked)
  useEffect(() => {
    (async () => {
        ...
        <div className="bg-white/90 backdrop-blur-sm p-8 rounded-2xl shadow-xl w-full max-w-md border border-slate-200">
          ...
          {isFirebaseConfigured() ? (
            ...
            <div className="mt-6 text-center text-sm text-slate-600">
              Google sign-in is disabled on this deployment. Please use email & password.
            </div>
          )}
